...
{
    public static async Task RunAppTranslator(string[] args)
    {
        ...
        for (int lineIndex = 0; lineIndex < totalLine; lineIndex++)
        {
            ...
            Console.WriteLine("text split count: " + textSplits.Length);
            ...
            Console.WriteLine($"progress {lineIndex + 1} / {totalLine} total");
